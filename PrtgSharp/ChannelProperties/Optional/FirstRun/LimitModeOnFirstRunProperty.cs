namespace PrtgSharp.ChannelProperties.Optional.FirstRun
{
    ...
    ///  but limits will be disabled. Note: This setting will be considered only on the first sensor 
    /// scan, when the channel is newly created; it is ignored on all further sensor scans (and may be
    ///  omitted). You can change this initial setting later in the Channel settings of the sensor.
    /// </summary>
